...
Число 110 содержится в интервале (25;200) */
        ...
        if ( x >= 25 &&  x <= 200) {
            ...
            System.out.println(" чиcло не попало в диапазон");
        }
...
!!! Вместо текстовых ответов ДА/НЕТ, используйте числа 0 - НЕТ и 1 - ДА */
       ...
       // }
//        int min = 1, max = 100;
//        System.out.println("введите 1, чтобы ответить да, введите 0, чтобы ответить нет") ;
//    Scanner uGuess = new Scanner(System.in);
//    if (uGuess == max-min/2)
